...
<head>
    ...
    <title>mprassDevelop Movie</title>
</head>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="input-group-append">
                    <a href="<?= base_url('personal'); ?>"><button class="btn btn-dark" type="button" id="search-button">Kembali</button></a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <script src="<?= base_url('assets/'); ?>js/script-restapi.js"></script>
</body>
